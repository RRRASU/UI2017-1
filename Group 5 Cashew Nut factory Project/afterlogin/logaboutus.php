		...
		<div class="layout">
			<div class="container">
				...
				<div class="info">
					...
					<p style="font-size:30px; margin-left:40px;margin-top:20px;">About Our Company</p>
					<p style="margin-left:80px; padding-right:15px">The cashew Nut factory is Established in the year 2017 the founders are Mr.Ranga Rayudu Rayapudi, Mr.Abhiram Mandalaparthi and Mr.Prathap Kotra. We are the forst genetarion Industrialist in the cashewnut asector. We are one of the leading companies in India. Govenment of india recognized our company as cashewnut star export house of cashew.</p>
					<br/>
					
					<p style="font-size:25px; margin-left: 60px;";> About Our Founders </p>
					<p style="margin-left: 80px; padding-right:15px">	Mr.Ranga Rayudu Rayapudi,Mr.Abhiram Mandalaparthi, Mr.Prathap kotra are youngsters hailing from a respectable family. They had the rarest opportunity to get exposed to cashew industry at a very young age. He is very conversant in all aspect of the cashew industry, right from procurement of raw cashew nut, processing and marketing.It is the fastest and leading growing organization in span of 4 months from a humble beginning.</p>
					<br>
					<p style="margin-left: 80px; padding-right:15px">	Today, Cashewnut Factory is a two star export house having processing units spread at different places in Andhrapradesh. Our experienced team with more than five hundred dedicated employees. Our well equipped processing centers own various certifications including for quality.</p>
					<br/>
					<!--
					<img src="rawcashews.jpg" height="150" width="150" style="padding-left:130px;"/>
					
					<img src="rawcashews.jpg" height="150" width="150" style="padding-left:90px;"/>
					<img src="rawcashews.jpg" height="150" width="150" style="padding-left:90px;"/>
					-->
