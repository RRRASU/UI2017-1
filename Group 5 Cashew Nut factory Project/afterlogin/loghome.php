...
<html>
	<head>
		...
		<meta charset="UTF-8"/>
		<link rel="stylesheet" href="loghome.css" type="text/css"/>
	...
	<div class="wrapper">
		<div class="layout">
			<div class="container">
						...
						<nav><ul><li><a onclick="window.location.href='logout.php'">Log Out</a></li>
				...
				<div class="info">
					...
					<div class="info_right">
						...
						<div class="images" style="margin-top:30px; margin-left:20px;">
						
							<div style="float: left;text-align: center;width: 30%;padding: 10px;">
							<img src="cashews.png" style="height:150px;width:150px"/>
							<p><b>Roasted Cashew</b></p>
							<p>These are superior quality cashew nuts coated with a sizzling blend of chilly and garlic, potent to raise cheers for its divine taste.</p>
							</div>
							<div style="float: left;text-align: center;width: 30%;padding: 10px;">
							<img src="dry-cashew-nut.jpg" style="height:150px;width:150px"/>
							<p>Dry Cashew nuts </p>
							<p>Gently Zingy, yet surely spicy, heavenly flavor Pepper Coated Cashew embodies the hearty combination of all the goodness of top quality cashew.</p>
							</div>
							<div style="float: left;text-align: center;width: 30%;padding: 10px;">
							<img src="marudhar-mewa-cashew.jpg" style="height:150px;width:150px"/>
							<p>Marudhar Cashew </p>
							<p>Perhaps one of the most popular cashew flavor, the oil roasted nuts are known for a very distinct taste.The cashew nuts roasted to a near golden hue in pure groundnut oil-one of the healthiest and preferred oil ever.</p>
							</div>
							<div style="float: left;text-align: center;width: 30%;padding: 10px;">
							<img src="cashew-nut-snack.jpg" style="height:150px;width:150px"/>
							<p>Cashew Nut Snack </p>
							<p>Palace offers topnotch quality plain cashew kernels in consumer pack.</p>
							</div>
							<div style="float: left;text-align: center;width: 30%;padding: 10px;">
							<img src="raw-cashew-nuts.jpg" style="height:150px;width:150px"/>
							<p>Raw Cashew </p>
							<p>Naturally obtained honey and precise processing are used to create these sweet sensations.</p>
							</div>
