		...
		<div class="layout">
			<div class="container">
				...
				<div class="info">
					...
					<h1>Be a CashewNut Factory Member</h1>
						<form method="POST" action="#">
			
				<input type="text" placeholder="First Name" name="firstname" value="<?php if(isset($_POST['signup'])) {echo $_POST['firstname'];} ?>"/><br/>
				<input type="text" name="lastname" placeholder="Last Name" value="<?php if(isset($_POST['signup'])) {echo $_POST['lastname'];}?>"/><br/>
				<input type="email"  placeholder="Enter Email..." name="email" value="<?php if(isset($_POST['signup'])) {echo $_POST['email'];}?>"/><br/>
				<input type="password" name="password" placeholder="Password" value="<?php if(isset($_POST['signup'])) {echo $_POST['password'];}?>"/><br/>
					<button type="submit" class="signUp_button" name="signup"><b>Sign Up</b></button>
					<p style="margin-top:10px">Already a member? Please <a href="Login.php#link6">Login</a></p>	
		           </form>
