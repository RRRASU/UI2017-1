		...
		<div class="layout">
			<div class="container">
				...
				<div class="info">
					...
					<div id="info_right_content" class="info_right_content" style="padding-left:50px;">
					<p style="font-size:30px; margin-left:40px;margin-top:20px;">Contact Us</p>
					<form>
						...
						Message:<textarea name="message" rows="10" cols="30" placeholder="Your message..."> </textarea>		
